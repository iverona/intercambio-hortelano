export default {
  ...
  "profile.upload_error": "Failed to upload photo",
  "profile.delete_photo_success": "Photo removed successfully",
  "profile.delete_photo_error": "Failed to remove photo",
  "profile.avatar_requirements": "Max 5MB. JPG, PNG, WEBP.",
  "profile.avatar_error_size": "Image size should be less than 5MB.",
  ...
  "product.contact.title": "Contact the Producer",
  "product.contact.description": "Select how you would like to contact the producer.",
  "product.contact.header": "Contact Producer",
  "product.contact.message_label": "Your Message (optional)",
  "product.contact.option_exchange": "PROPOSE EXCHANGE",
  "product.contact.exchange_desc": "Propose a sustainable trade using one of your active products.",
  "product.contact.your_product": "Your product for exchange",
  "product.contact.button_exchange": "Propose Exchange",
  ...
  "categories.handmade": "Handmade Goods",
  ...
  "exchanges.details.breadcrumb.home": "Home",
  "exchanges.details.breadcrumb.exchanges": "Exchanges",
  "exchanges.details.offer_label": "{type} Offer",
  "exchanges.details.swapping_for": "Swapping for: {product}",
  "exchanges.details.status_desc_accepted": "Exchange in progress. Use chat to coordinate.",
  "exchanges.details.status_desc_completed": "This exchange has been completed successfully.",
  "exchanges.details.status_desc_rejected": "This offer was declined.",
  ...
  "login.error.invalid_email": "The email address is not valid.",
  "login.error.user_disabled": "This account has been disabled.",
  "login.error.user_not_found": "There is no account with this email.",
  "login.error.wrong_password": "The password is incorrect.",
  "login.error.invalid_credential": "The credentials are incorrect or have expired.",
  "login.error.too_many_requests": "Too many failed attempts. Please try again later.",
  "login.error.missing_password": "Please enter your password.",
  "login.error.email_not_verified": "Your email is not verified. Please check your inbox for the verification link.",
  "login.error.popup_closed": "The login window was closed before completing the process.",
  "login.error.account_exists": "An account already exists with a different sign-in method linked to this email.",
  ...
  "signup.notifications_consent": "I understand that I will receive email notifications about my activity on the platform, which I can configure from my profile.",
  "signup.error_terms_required": "You must accept the Privacy Policy and Legal Notice to sign up",
  "signup.error.invalid_email": "The email address is not valid.",
  "signup.error.weak_password": "The password is too weak (must be at least 6 characters long).",
  "signup.error.generic": "An error occurred while signing up. Please try again.",
  ...
  "auth_action.loading": "Loading...",

  "auth_action.reset_password.description": "Enter a new password for {email}",
  "auth_action.reset_password.instruction": "Enter a new password for {email}",
  ...
  "auth_action.reset_password.password_mismatch": "Passwords do not match.",
  "auth_action.reset_password.password_too_short": "Password must be at least 6 characters long.",
  "auth_action.reset_password.title": "Reset Password",
  "auth_action.verify_email.title": "Verify Email",
  "auth_action.recover_email.title": "Recover Email",
  "auth_action.title": "Authentication",
  ...
  "auth_action.error.unknown_mode": "Unknown action mode. Please use the link provided in your email.",
  "auth_action.error.user_disabled": "This account has been disabled.",
  "auth_action.error.user_not_found": "User account not found.",
  "auth_action.error.weak_password": "Password is too weak.",
  ...
  "onboarding.step_terms": "Terms Acceptance",
  "onboarding.terms_description": "Please accept our terms and conditions to continue.",
  "onboarding.terms_title": "Terms & Conditions",
  "onboarding.profile_step_title": "Profile Information",
  "onboarding.profile_step_description": "Tell us about yourself and your garden so the community can get to know you better",
  "onboarding.location_step_title": "Share Your Location",
  "onboarding.location_step_description": "Your location helps us show you nearby products",
  "onboarding.name_label": "Name",
  "onboarding.name_placeholder": "Your name",
  "onboarding.name_required": "Name is required",
  "onboarding.name_too_short": "Name must be at least 2 characters",
  "onboarding.bio_label": "Bio",
  "onboarding.bio_placeholder": "Example: I've been growing tomatoes, lettuce, and zucchini in my garden for 5 years. I love sharing my harvest with the local community...",
  "onboarding.bio_help": "Minimum 10 characters, maximum 500",
  "onboarding.bio_required": "Bio is required",
  "onboarding.bio_too_short": "Bio must be at least 10 characters",
  "onboarding.bio_too_long": "Bio cannot exceed 500 characters",
  "onboarding.avatar_label": "Profile Picture (Optional)",
  "onboarding.next_button": "Next",
  "onboarding.back_to_profile": "Back to Step 1",
  ...
  "contact.subtitle": "Got questions or suggestions? We're here to listen and improve the community together.",
