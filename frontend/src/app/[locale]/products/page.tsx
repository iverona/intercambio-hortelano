        ...
        <main className="container mx-auto px-4 py-12">
            ...
            <div className="mb-10">
                <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-6 gap-4">
                    ...
                    <div className="flex gap-4 items-center w-full md:w-auto">
                        {/* Filter component for mobile/desktop if not in header, 
                 but header has it. We might want it here too or rely on Header.
                 For now, let's keep reliance on Header filter or add inline if needed.
                 The original design had it in header. 
                 Let's add a visual cue or keep it simple. 
             */}
                    </div>
                </div>
            ...
            {loading ? (
                ...
                <EmptyState
                    ...
                    action={
                        user ? (
                            <Button asChild className="group bg-[#879385] hover:bg-[#7a8578]">
                                <Link href="/publish">
