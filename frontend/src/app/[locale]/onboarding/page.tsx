...
import { MapPin, User, Camera, Loader2, ArrowLeft } from "lucide-react";
...
export default function OnboardingPage() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-b from-gray-50 to-white dark:from-gray-950 dark:to-gray-900 p-4">
            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-col items-center gap-4">
                ...
                <div className="relative group">
                  <Avatar className="h-32 w-32 border-4 border-white dark:border-gray-700 shadow-xl ring-4 ring-green-100 dark:ring-green-900">
                    <AvatarImage src={avatarPreview || undefined} alt="Preview" className="object-cover" />
                    <AvatarFallback className="text-4xl font-bold bg-gradient-to-br from-green-500 to-emerald-500 text-white">
                      {name
                        ? name
                            .split(" ")
                            .map((n) => n[0])
