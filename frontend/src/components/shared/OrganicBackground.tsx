...
export function OrganicBackground({ children, className = "" }: OrganicBackgroundProps) {
    return (
        <div className={`relative min-h-screen overflow-hidden bg-[#FFFBE6] dark:bg-[#2C2A25] flex flex-col items-center py-8 px-4 transition-colors duration-300 ${className}`}>
            {/* Background Blobs */}
